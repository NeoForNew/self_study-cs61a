...
class VendingMachine:
    ...
    def restock(self, nums):
        self.total_nums += nums
        return f'Current {self.item} stock: {self.total_nums}'
...
class Coin:
    ...
    def worth(self):
        "*** YOUR CODE self.year = current_yearHERE ***"
        time = Mint.current_year - self.year
        return self.cents + (0 if time<50 else time-50)#()comprehension

class Nickel(Coin):#inheritance
    cents = 5
